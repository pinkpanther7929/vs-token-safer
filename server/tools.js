  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        detail: { type: "string", description: "`file`|`dir` → blast-radius summary instead of the per-line list." },
        direction: { type: "string", description: "callers|callees → multi-hop call hierarchy instead of flat refs." },
        depth: { type: "number", description: "Call-hierarchy hops when direction is set (default 2)." },
